        ...
        lndu.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> ov, Number value, Number new_value) {
                ...
                if(new_value.intValue() == 1) {
                    ...
                    switch (randansw.get(0)) {
                        case 0:
                            rbtimg1.setImage(blanks1.get(randblank.get(4)));
                            ...
                            break;
                        case 1:
                            rbtimg2.setImage(blanks1.get(randblank.get(4)));
                            ...
                            break;
                        case 2:
                            rbtimg3.setImage(blanks1.get(randblank.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank.get(0)));
                            ...
                            break;
                        case 3:
                            rbtimg4.setImage(blanks1.get(randblank.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank.get(0)));
                            rbtimg3.setImage(blanks1.get(randblank.get(1)));
                            ...
                            break;
                        case 4:
                            rbtimg5.setImage(blanks1.get(randblank.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank.get(0)));
                            rbtimg3.setImage(blanks1.get(randblank.get(1)));
                            rbtimg4.setImage(blanks1.get(randblank.get(2)));
