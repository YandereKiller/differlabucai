...
public class ControllerSolution6 implements Initializable {
    static Map<Integer, Image> soltask3 = new HashMap<>(){
        {
            put(1,new Image(getClass().getResourceAsStream("/ImagesTasks/12c.png")));
            put(2,new Image(getClass().getResourceAsStream("/ImagesTasks/22c.png")));
            put(3,new Image(getClass().getResourceAsStream("/ImagesTasks/32c.png")));
            put(4,new Image(getClass().getResourceAsStream("/ImagesTasks/42c.png")));
            put(5,new Image(getClass().getResourceAsStream("/ImagesTasks/52c.png")));
            put(6,new Image(getClass().getResourceAsStream("/ImagesTasks/62c.png")));
            put(7,new Image(getClass().getResourceAsStream("/ImagesTasks/72c.png")));
            put(8,new Image(getClass().getResourceAsStream("/ImagesTasks/82c.png")));
            put(9,new Image(getClass().getResourceAsStream("/ImagesTasks/92c.png")));
            put(10,new Image(getClass().getResourceAsStream("/ImagesTasks/102c.png")));
            put(11,new Image(getClass().getResourceAsStream("/ImagesTasks/112c.png")));
            put(12,new Image(getClass().getResourceAsStream("/ImagesTasks/122c.png")));
            put(13,new Image(getClass().getResourceAsStream("/ImagesTasks/132c.png")));
            put(14,new Image(getClass().getResourceAsStream("/ImagesTasks/142c.png")));
            put(15,new Image(getClass().getResourceAsStream("/ImagesTasks/152c.png")));
        }
    };  // (var, task)
    static Map<Integer,Image> answtask = new HashMap<>(){
        {
            put(1,new Image(getClass().getResourceAsStream("/Answers/12c.png")));
            put(2,new Image(getClass().getResourceAsStream("/Answers/22c.png")));
            put(3,new Image(getClass().getResourceAsStream("/Answers/32c.png")));
            put(4,new Image(getClass().getResourceAsStream("/Answers/42c.png")));
            put(5,new Image(getClass().getResourceAsStream("/Answers/52c.png")));
            put(6,new Image(getClass().getResourceAsStream("/Answers/62c.png")));
            put(7,new Image(getClass().getResourceAsStream("/Answers/72c.png")));
            put(8,new Image(getClass().getResourceAsStream("/Answers/82c.png")));
            put(9,new Image(getClass().getResourceAsStream("/Answers/92c.png")));
            put(10,new Image(getClass().getResourceAsStream("/Answers/102c.png")));
            put(11,new Image(getClass().getResourceAsStream("/Answers/112c.png")));
            put(12,new Image(getClass().getResourceAsStream("/Answers/122c.png")));
            put(13,new Image(getClass().getResourceAsStream("/Answers/132c.png")));
            put(14,new Image(getClass().getResourceAsStream("/Answers/142c.png")));
            put(15,new Image(getClass().getResourceAsStream("/Answers/152c.png")));
        }
    };
    private List<Image> blanks1 = new ArrayList<>(){
        {
            ...
            add(new Image(getClass().getResourceAsStream("/Answers/12b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/22b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/32b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/42b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/52b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/62b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/72b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/82b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/92b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/102b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/112b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/122b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/132b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/142b.png")));
            add(new Image(getClass().getResourceAsStream("/Answers/152b.png")));
                ...
                if(new_value.intValue() == 1) {
                    ...
                    switch (randansw.get(0)) {
                        case 0:
                            ...
                            rbtimg4.setImage(answtask.get(randanswblank.get(1)));
                            rbtimg5.setImage(answtask.get(randanswblank.get(2)));
                            break;
                        case 1:
                        ...
                        case 4:
                            ...
                            rbtimg3.setImage(answtask.get(randanswblank.get(0)));
                            rbtimg4.setImage(answtask.get(randanswblank.get(1)));
                            rbtimg1.setImage(answtask.get(randanswblank.get(2)));
                            break;
                    }
                } else {
                    isrightsel = false;
                    ...
                    switch (randansw.get(0)) {
                        case 0:
                            rbtimg1.setImage(blanks1.get(randblank1.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank1.get(0)));
                            rbtimg3.setImage(blanks1.get(randblank1.get(1)));
                            rbtimg4.setImage(blanks1.get(randblank1.get(2)));
                            rbtimg5.setImage(blanks1.get(randblank1.get(3)));
                            break;
                        case 1:
                            rbtimg2.setImage(blanks1.get(randblank1.get(4)));
                            ...
                            break;
                        case 2:
                            rbtimg3.setImage(blanks1.get(randblank1.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank1.get(0)));
                            ...
                            break;
                        case 3:
                            rbtimg4.setImage(blanks1.get(randblank1.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank1.get(0)));
                            rbtimg3.setImage(blanks1.get(randblank1.get(1)));
                            rbtimg1.setImage(blanks1.get(randblank1.get(2)));
                            rbtimg5.setImage(blanks1.get(randblank1.get(3)));
                            break;
                        case 4:
                            rbtimg5.setImage(blanks1.get(randblank1.get(4)));
                            rbtimg2.setImage(blanks1.get(randblank1.get(0)));
                            rbtimg3.setImage(blanks1.get(randblank1.get(1)));
                            rbtimg4.setImage(blanks1.get(randblank1.get(2)));
                            rbtimg1.setImage(blanks1.get(randblank1.get(3)));
                            break;
                    }
                }
