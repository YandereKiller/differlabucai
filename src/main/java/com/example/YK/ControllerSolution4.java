    ...
    static Map<Integer, Image> soltask3 = new HashMap<>(){
        {
            ...
            put(2,new Image(getClass().getResourceAsStream("/ImagesTasks/22a.png")));
            put(3,new Image(getClass().getResourceAsStream("/ImagesTasks/32a.png")));
            put(4,new Image(getClass().getResourceAsStream("/ImagesTasks/42a.png")));
            put(5,new Image(getClass().getResourceAsStream("/ImagesTasks/52a.png")));
            put(6,new Image(getClass().getResourceAsStream("/ImagesTasks/62a.png")));
            put(7,new Image(getClass().getResourceAsStream("/ImagesTasks/72a.png")));
            put(8,new Image(getClass().getResourceAsStream("/ImagesTasks/82a.png")));
            put(9,new Image(getClass().getResourceAsStream("/ImagesTasks/92a.png")));
            put(10,new Image(getClass().getResourceAsStream("/ImagesTasks/102a.png")));
            put(11,new Image(getClass().getResourceAsStream("/ImagesTasks/112a.png")));
            put(12,new Image(getClass().getResourceAsStream("/ImagesTasks/122a.png")));
            put(13,new Image(getClass().getResourceAsStream("/ImagesTasks/132a.png")));
            put(14,new Image(getClass().getResourceAsStream("/ImagesTasks/142a.png")));
            put(15,new Image(getClass().getResourceAsStream("/ImagesTasks/152a.png")));
        }
    };  // (var, task)
    static Map<Integer,Image> answtask = new HashMap<>(){
        {
            put(1,new Image(getClass().getResourceAsStream("/Answers/12a.png")));
            put(2,new Image(getClass().getResourceAsStream("/Answers/22a.png")));
            put(3,new Image(getClass().getResourceAsStream("/Answers/32a.png")));
            put(4,new Image(getClass().getResourceAsStream("/Answers/42a.png")));
            put(5,new Image(getClass().getResourceAsStream("/Answers/52a.png")));
            put(6,new Image(getClass().getResourceAsStream("/Answers/62a.png")));
            put(7,new Image(getClass().getResourceAsStream("/Answers/72a.png")));
            put(8,new Image(getClass().getResourceAsStream("/Answers/82a.png")));
            put(9,new Image(getClass().getResourceAsStream("/Answers/92a.png")));
            put(10,new Image(getClass().getResourceAsStream("/Answers/102a.png")));
            put(11,new Image(getClass().getResourceAsStream("/Answers/112a.png")));
            put(12,new Image(getClass().getResourceAsStream("/Answers/122a.png")));
            put(13,new Image(getClass().getResourceAsStream("/Answers/132a.png")));
            put(14,new Image(getClass().getResourceAsStream("/Answers/142a.png")));
            put(15,new Image(getClass().getResourceAsStream("/Answers/152a.png")));
        }
    };
